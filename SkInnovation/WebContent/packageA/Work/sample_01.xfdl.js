(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_Clear",null,"26","80","30","256",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("초기화");
            ...
            obj = new Button("btn_Excel","btn_Search:2","26","80","30",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Exp");
            ...
            obj.set_cssclass("sta_WF_infoBox");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_SM","8","Static09:34",null,null,"10","8",null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj.set_text("양호");
            obj.set_textAlign("center");
            obj.set_cssclass("sta_WF_markWhite");
            this.addChild(obj.name, obj);
            ...
            obj.set_text("요주의");
            obj.set_textAlign("center");
            obj.set_cssclass("sta_WF_markBlue");
            this.addChild(obj.name, obj);
            ...
            obj.set_text("불량");
            obj.set_textAlign("center");
            obj.set_cssclass("sta_WF_markRed");
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",1024,768,this,
                ...
                p.Static15.set_taborder("31");
                p.Static15.set_cssclass("sta_WF_boxBg");
                p.Static15.set_text("");
                ...
                p.btn_Clear.set_taborder("10");
                p.btn_Clear.set_text("초기화");
                p.btn_Clear.set_cssclass("btn_WF_btnInitial");
                p.btn_Clear.move(null,"26","80","30","256",null);

                p.btn_Search.set_taborder("11");
                p.btn_Search.set_text("조회");
                p.btn_Search.set_cssclass("btn_WF_btnSearch");
                p.btn_Search.move("btn_Clear:2","26","80","30",null,null);

                p.btn_Excel.set_taborder("2");
                p.btn_Excel.set_text("Exp");
                p.btn_Excel.set_cssclass("btn_WF_btnExp");
                p.btn_Excel.move("btn_Search:2","26","80","30",null,null);

                p.btn_Excel00.set_taborder("9");
                p.btn_Excel00.set_text("닫기");
                p.btn_Excel00.set_cssclass("btn_WF_btnWhite");
                p.btn_Excel00.move(null,"26","80","30","10",null);

                p.Static09.set_taborder("8");
                p.Static09.set_text(" 판정기준 1) % of Ref, Value : 71이상 양호, 2) % of Ref, Value : 61 ~ 70 요주의, 3) % of Ref, Value : 60 이하 불량.\r\n 참조 : Ref, (Reference, 기준Conductance).");
                p.Static09.set_cssclass("sta_WF_infoBox");
                p.Static09.move("10","293",null,"65","10",null);

                p.grd_SM.set_taborder("3");
                p.grd_SM.set_scrolldisplaymode("normal");
                p.grd_SM.set_scrollpixel("none");
                p.grd_SM.set_binddataset("dsOutput");
                p.grd_SM.set_useselcolor("false");
                p.grd_SM.move("8","Static09:34",null,null,"10","8");

                p.Static08.set_taborder("6");
                ...
                p.Static00.set_cssclass("sta_WF_boxBg");
                p.Static00.move("10","62",null,"50","9",null);

                p.GroupBox00.set_taborder("13");
            ...
            obj = new Layout("Layout0","",480,1300,this,
                ...
                p.grd_SM.move("8","976",null,"316","10",null);
                ...
                p.btn_Excel.set_text("Exp");
                p.btn_Excel.move("btn_Search:3","58","23.13%","54",null,null);
                ...
                p.btn_Excel00.set_text("닫기");
                p.btn_Excel00.move("btn_Excel:3","58",null,"54","8",null);
