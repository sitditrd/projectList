...
class LayoutTest extends Frame {
	...
	public LayoutTest() {
		...
		this.add(BorderLayout.NORTH, northBtn); //방향, 컴포넌트
		this.add(centerBtn, BorderLayout.CENTER); //컴포넌트, 방향  (위처럼 안하고 아래처럼 해도 된다.)
		this.add("South", southBtn); //BorderLayOut.SOUTH으로 안하고 이런식으로 하긴 하는데 권장하지는 않는다.
