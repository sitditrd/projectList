...
if (!nexacro.MultiCombo)
{
    ...
    _pMultiCombo.popupwidth = 200;
    _pMultiCombo.popupheight = 130;
    ...
    _pMultiCombo.on_create_contents = function()
    {
        ...
        obj = new nexacro.Button("dropbutton", null, 0, 17, null, 1, 0, null, null, null, null);
        obj.set_cssclass("MultiComboButton");
        this.form.addChild("dropbutton", obj);

        obj = new nexacro.PopupDiv("combolistpopupdiv", 0, 19, 300, 194, null, null, null, null, null, null);
        obj.set_cssclass("MultiComboPopupDiv");
        obj.form.set_scrollbartype("none");
        this.addChild("combolistpopupdiv", obj);

        obj = new nexacro.CheckBox("allcheckbox", 7, 1, 60, 20, null, null, null, null, null, null);
        obj.set_text("ALL");
        this.form.combolistpopupdiv.addChild("allcheckbox", obj);

        obj = new nexacro.Button("okbutton", null, 2, 39, 16, 53, null, null, null, null, null);
        obj.set_text("OK");
        this.form.combolistpopupdiv.addChild("okbutton", obj);

        obj = new nexacro.Button("cancelbutton", null, 2, 49, 16, 1, null, null, null, null, null);
        obj.set_text("Cancel");
        this.form.combolistpopupdiv.addChild("cancelbutton", obj);

        obj = new nexacro.Grid("combolistgrid", -1, 21, null, null, -1, -1, null, null, null, null);
        ...
        this.set_border("1px solid #777777");
    ...
    _pMultiCombo.showComboList = function()
    {
        ...
        var iLeft = -1;
        var iTop = this.form.comboedit.getOffsetHeight() + 1;
