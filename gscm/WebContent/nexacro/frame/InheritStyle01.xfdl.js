(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("InheritStyle01.xfdl", function() {

        this.InheritStyle01_onload = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload",this.InheritStyle01_onload,this);
        };

        this.loadIncludeScript("InheritStyle01.xfdl");
