(function()
{
	return function()
	{
		nexacro._setCSSMaps(
		{
			...
			"Calendar" :
			{
				"self" :
				{
					...
					"mouseover" :
					{
						"border" : nexacro.BorderObject("1px solid #3366cc")
					},
					"focused" :
					{
						"border" : nexacro.BorderObject("1px solid #3366cc")
			...
			"Grid" :
			{
				"self" :
				{
					"enabled" :
					{
						"border" : nexacro.BorderObject("2px solid #3366cc, 1px solid #c7c7c7, 1px solid #c7c7c7, 1px solid #c7c7c7")
					}
				}
			},
			"cell" :
			{
				...
				"class" :
				{
					...
					"Expr_Case_Background_lightpink" :
					{
						"parent" :
						{
							"row" :
					...
					"GridCellControl" :
					{
						"self" :
						{
							"enabled" :
							{
								"font" : nexacro.FontObject("12px Gulim"),
								"border" : nexacro.BorderObject("1px solid #777777"),
								"padding" : nexacro.PaddingObject("1px 5px 0px 5px")
							},
							"mouseover" :
							{
								"border" : nexacro.BorderObject("1px solid #3366cc")
				...
				"parent" :
				{
						...
						"parent" :
						{
							"Menu" :
							{
								"self" :
								{
									"enabled" :
									{
										"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Popupmenuprev.png')")
									},
									"mouseover" :
									{
										"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Popupmenuprev_O.png')")
									},
									"disabled" :
									{
										"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Popupmenuprev_D.png')")
									}
								}
							}
						}
					...
					"PopupMenu" :
					{
						"self" :
						{
							"enabled" :
							{
								"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Popupmenuprev2.png')")
							},
							"mouseover" :
							{
								"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Popupmenuprev2_O.png')")
							},
							"disabled" :
							{
								"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Popupmenuprev2_D.png')")
							}
						}
					},
					"PopupMenuControl" :
						...
						"parent" :
						{
							"DatePickerControl" :
							{
								"self" :
								{
									...
									"disabled" :
									{
										"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Calprev_D.png')")
									}
								}
							}
						}
				...
				"parent" :
				{
						...
						"parent" :
						{
							"Menu" :
							{
								"self" :
								{
									"enabled" :
									{
										"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Popupmenunext.png')")
									},
									"mouseover" :
									{
										"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Popupmenunext_O.png')")
									},
									"disabled" :
									{
										"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Popupmenunext_D.png')")
									}
								}
							}
						}
					...
					"PopupMenu" :
					{
						"self" :
						{
							"enabled" :
							{
								"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Popupmenunext2.png')")
							},
							"mouseover" :
							{
								"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Popupmenunext2_O.png')")
							},
							"disabled" :
							{
								"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Popupmenunext2_D.png')")
							}
						}
					},
					"PopupMenuControl" :
						...
						"parent" :
						{
							"DatePickerControl" :
							{
								"self" :
								{
									...
									"disabled" :
									{
										"icon" : nexacro.UrlObject("URL('theme://images/btn_WF_Calnext_D.png')")
									}
								}
							}
						}
				...
				"parent" :
				{
					"Menu" :
					{
						"self" :
						{
							"enabled" :
							{
								"font" : nexacro.FontObject("bold 13px Arial,Gulim"),
								"color" : nexacro.ColorObject("#ffffff"),
					...
					"Menu" :
					{
						"self" :
						{
							"enabled" :
							{
								"font" : nexacro.FontObject("12px Gulim"),
								"color" : nexacro.ColorObject("#222222"),
								"border" : nexacro.BorderObject("1px solid #274e9b")
							}
						}
					}
				}
						...
						"parent" :
						{
							"Menu" :
							{
								"self" :
								{
									...
									{
										"color" : nexacro.ColorObject("#ffffff"),
										"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #6088d7, 0px none"),
										"padding" : nexacro.PaddingObject("5px 8px 3px 8px")
									},
									"mouseover" :
									{
										"color" : nexacro.ColorObject("#ffffff")
									...
									"disabled" :
									{
										"color" : nexacro.ColorObject("#859edc")
									}
								}
							}
						}
								...
								"parent" :
								{
									"Menu" :
									{
										"self" :
										{
											"enabled" :
											{
												"icon" : nexacro.UrlObject("URL('theme://images/img_WF_Menuitem.png')")
											}
										}
									}
								}
								...
								"parent" :
								{
									"DatePickerControl" :
									{
										"self" :
										{
											"enabled" :
											{
												"font" : nexacro.FontObject("bold 15px \"Arial\""),
												"color" : nexacro.ColorObject("#ffffff")
											}
										}
									}
				...
				"parent" :
				{
					"Tab" :
					{
						"self" :
						{
							"enabled" :
							{
								"border" : nexacro.BorderObject("1px solid #88abeb")
							}
						}
					}
				}
				...
				"parent" :
				{
					"Tab" :
					{
						"self" :
						{
							...
							"selected" :
							{
								"color" : nexacro.ColorObject("#0341ac"),
								"border" : nexacro.BorderObject("1px solid #85adeb,1px solid #85adeb,1px solid #f6f9ff,1px solid #85adeb")
							},
							"focused_selected" :
							{
								"color" : nexacro.ColorObject("#0341ac"),
					...
					"DatePickerControl" :
					{
						"self" :
						{
							"enabled" :
							{
								...
								"border" : nexacro.BorderObject("1px solid #3366cc, 1px solid #c7c7c7, 1px solid #c7c7c7, 1px solid #c7c7c7")
							}
						}
					}
				}
		...
		imgcache[nexacro._getImageLocation("theme://images/btn_WF_Calendar.png")] = { width:15, height:15 };
		imgcache[nexacro._getImageLocation("theme://images/btn_WF_Calendar_D.png")] = { width:15, height:15 };
		...
		imgcache[nexacro._getImageLocation("imagerc::img_TP_menuLine.png")] = { width:2, height:20 };
		...
		imgcache[nexacro._getImageLocation("theme://images/btn_WF_Calprev_D.png")] = { width:6, height:9 };
		...
		imgcache[nexacro._getImageLocation("theme://images/btn_WF_Calnext_D.png")] = { width:6, height:9 };
