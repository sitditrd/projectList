(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static34","10","10","220",null,null,"60",null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("Button09",null,"710","60","24","10",null,null,null,null,null,this);
            obj.set_taborder("72");
            obj.set_text("Exit");
            obj.set_cssclass("btn_WF_basic04");
            this.addChild(obj.name, obj);

            obj = new Button("Button04",null,"710","60","24","74",null,null,null,null,null,this);
            obj.set_taborder("73");
            obj.set_text("Clear");
            obj.set_cssclass("btn_WF_basic04");
            this.addChild(obj.name, obj);

            obj = new Button("Button05",null,"710","60","24","138",null,null,null,null,null,this);
            obj.set_taborder("74");
            obj.set_text("OK");
        ...
        this.loadIncludeScript("w_dpsvusp00000.xfdl");
