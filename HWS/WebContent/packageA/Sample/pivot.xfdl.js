(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static02","8","130",null,"44","8",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_background("#f6f6f6");
            obj.set_text("");
            obj.set_border("1px solid orange");
            this.addChild(obj.name, obj);
            ...
            obj = new NxPivot("NxPivot00","8","184",null,null,"8","8",null,null,null,null,this);
            obj.set_taborder("8");
        ...
        {
        	var sId = "SEARCH";
        	var sURL = "http://localhost/MIRAEASSET/service/pivot/PivotssvRead.jsp?rowcount="+this.cmbCount.value;
        	var sInDs = "";
