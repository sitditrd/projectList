 ...
 * 결    과 	: 오른쪽 부분이 얻어진 문자열.
 *********************************************************************/
pForm.gfn_Right = function(strString, nSize)
{
 ...
 * 결    과 	: integer
******************************************************************************/
pForm.gfn_diffTime = function(sStartTime, sEndTime, sType)
{
...
pForm.gfnFormat = function(sTime)
{
	var nFrom_HH = parseInt(sTime.substring(0, 2));
	var nFrom_mm = parseInt(sTime.substring(2, 4));
	var nFrom_ss = parseInt(sTime.substring(4, 6));
	var nFrom_ms = parseInt(sTime.substring(6, 9));
	
	return nFrom_HH + ":" + nFrom_mm + ":" +  nFrom_ss + "." + nFrom_ms;
};
