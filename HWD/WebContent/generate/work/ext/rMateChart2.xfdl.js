    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Layout("default","desktop",980,850,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("rChart연동");
                p.set_scrollbartype("autoindicator autoindicator");

                p.WebBrowser00.set_taborder("0");
                p.WebBrowser00.move("10","140",null,"403","20",null);

                p.grdList.set_taborder("0");
                p.grdList.set_binddataset("dsList");
                p.grdList.set_autofittype("col");
                p.grdList.set_autoenter("select");
                p.grdList.move("10","550",null,"280","20",null);

                p.Static36.set_taborder("1");
                p.Static36.set_text("rChart는 데스크탑 및 모바일용 웹차트 컴포넌트입니다.\r\nIE, 크롬, 파이어폭스, 사파리 등의 브라우저에서 사용이 가능합니다.(IE7, 8 에서도 사용 가능)\r\n넥사크로 플랫폼과 연동하여 다양한 화면을 구성할 수 있으며, Grid의 데이터 수정을 통하여 확인할 수 있습니다.");
                p.Static36.set_cssclass("sta_WF_box03");
                p.Static36.set_wordWrap("char");
                p.Static36.move("0","0",null,"96","20",null);

                p.cmbType.set_taborder("2");
                p.cmbType.set_innerdataset(cmbType_innerdataset);
                p.cmbType.set_codecolumn("codecolumn");
                p.cmbType.set_datacolumn("datacolumn");
                p.cmbType.set_text("Bar");
                p.cmbType.set_value("Bar");
                p.cmbType.set_index("0");
                p.cmbType.move("0","103","150","30",null,null);
            	}
            );
            ...
            //-- Normal Layout : this
            obj = new Layout("Layout0","",480,1080,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                p = rootobj;
                p.WebBrowser00.move("20","280",null,"403","20",null);

                p.grdList.move("10","710",null,null,"20","30");

                p.cmbType.move("20","213","240","50",null,null);

                p.Static36.move("20","20",null,"170","20",null);
            	}
            );
            obj.set_mobileorientation("landscape");
            this.addLayout(obj.name, obj);
...
';
        ...
        {
        	var webRoot = nexacro.getApplication().gvWebUrl;
        ...
        {
        	this.rMateChartSetLayout(this.WebBrowser00, this.layoutBarStr);
        ...
        this.cmbType_onitemchanged = function(obj,e)
        {
        	...
        	if (e.postvalue == "Bar") {
        		chartLayout = this.layoutBarStr;
        	} else if (e.postvalue == "Line") {
        		chartLayout = this.layoutLineStr;
        	} else if (e.postvalue == "Combination") {
