(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static03","10","60",null,"48","10",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_cssclass("sta_WF_box02");
            this.addChild(obj.name, obj);

            obj = new WebBrowser("WebBrowser00","10","120",null,null,"10","20",null,null,null,null,this);
            obj.set_taborder("0");
            this.addChild(obj.name, obj);

            obj = new Static("Static18","30","73","70","20",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("차트유형");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbType","119","68","263","30",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Static("stcTitle","10","0",null,"50","10",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_popTitle01");
            obj.set_text("알차트(rChart) 미리보기");
            this.addChild(obj.name, obj);

            obj = new Button("btnClose",null,"10","40","40","10",null,null,null,null,null,this);
            obj.set_taborder("3");
        ...
        */
        ...
        {
        	this.svcurl = nexacro.getApplication().gvWebUrl;
        	...
        	this.sUrl = this.objects["ds_" + sType].getColumn(0, "Code");
        	this.fn_changeUrl(this.sUrl);
        };
        ...
        {
        	this.WebBrowser00.set_url(this.svcurl + "/rChart/Samples/" + this.sUrl + ".html");
        };
