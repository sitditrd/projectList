(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_stacktotallinestyle("1px solid #dddddd");
            obj._setContents({
            	"title": {
            		"id": "title",
            		"text": "Bar Chart",
            	...
            	"seriesset": [
            		{
            			...
            			"valuecolumn": "bind:d1",
            			"stacktype": "normal",
            			"barfillstyle": "linear-gradient(to left,#66ffff 0%,#4572A7 30%, #4572A7 70%, #66ffff 100%)",
            			"linevisible": "false",
            		...
            		},
            		{
            			...
            			"valuecolumn": "bind:d2",
            			"stacktype": "normal",
            			"barfillstyle": "linear-gradient(to left,#fadad9 0%,#AA4643 30%, #AA4643 70%, #fadad9 100%)",
            			"barlinestyle": "1px solid white",
            			"stacktotalvisible": "true",
            			"stacktotallinestyle": "1px solid gray"
            		},
            		{
            			...
            			"valuecolumn": "bind:d3",
            			"stacktype": "normal",
            			"barfillstyle": "linear-gradient(to left,#e7f7c3 0%,#89A54E 30%, #89A54E 70%, #e7f7c3 100%)",
            			"barlinestyle": "1px solid white",
            			"stacktotalvisible": "true",
            			"stacktotallinestyle": "1px solid gray"
            		}
