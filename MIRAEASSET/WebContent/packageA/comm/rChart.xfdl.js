(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Line","-6","6","142","95",null,null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        {
        	nxlib.openPopup(this, "rChartPop", "comm::rChartPop.xfdl", {chartType: obj.name}, "showtitlebar=false layered=true");
        }
        });
