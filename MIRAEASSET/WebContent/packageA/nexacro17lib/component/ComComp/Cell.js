...
if (!nexacro.CellInfo) {
	...
	/* Chart 추가 */
	_pCellInfo._property_map_chart = [["charttype", "charttype", false, "", false]]
	;

	/* Sparkline 추가 */
	_pCellInfo._property_map_sparkline = [["sparklineoptions", "options", false, "", false]]
	;
	...
	/* Chart 추가 */
	_pCellInfo._property_map = _pCellInfo._property_map.concat(_pCellInfo._property_map_chart);
	/* Sparkline 추가 */
	_pCellInfo._property_map = _pCellInfo._property_map.concat(_pCellInfo._property_map_sparkline);
	...
	/* Chart 종류 */
	_pCellInfo.set_charttype = function (v) {
		if (v != this.charttype) {
			this.charttype = v;
		}
	};
	...
	/* Sparkline 추가 */
	_pCellInfo.set_sparklineoptions = function (v) {
		if (v !== null && v !== undefined) {
			if (nexacro._isString(v)) {
				this.sparklineoptions = JSON.parse(v);
			}
		}
	};
