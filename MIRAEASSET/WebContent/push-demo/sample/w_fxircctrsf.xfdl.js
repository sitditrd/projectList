(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Button01","10",null,"100","24",null,"30",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Swift Message");
            obj.set_cssclass("btn_WF_basic01");
            this.addChild(obj.name, obj);

            obj = new Button("Button09",null,null,"60","24","10","30",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Exit");
            obj.set_cssclass("btn_WF_basic04");
            this.addChild(obj.name, obj);

            obj = new Button("Button14",null,null,"60","24","73","30",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Clear");
            obj.set_cssclass("btn_WF_basic04");
            this.addChild(obj.name, obj);

            obj = new Button("Button15",null,null,"60","24","136","30",null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("OK");
            obj.set_cssclass("btn_WF_basic05");
            this.addChild(obj.name, obj);

            obj = new Button("Button02","113",null,"66","24",null,"30",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("Unsettled");
            obj.set_cssclass("btn_WF_basic01");
            this.addChild(obj.name, obj);

            obj = new Tab("Tab00","8","450",null,"300","8",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_tabindex("0");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static37","1","5",null,"230","1",null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("0");
            obj.set_cssclass("sta_WF_box01");
            obj.set_text("");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Static("Static15","7","21","115","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("1");
            obj.set_text("Remitting Bank");
            obj.set_cssclass("sta_WF_label01");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Static("Static00","7","49","125","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("2");
            obj.set_text("Reimbursing Bank");
            obj.set_cssclass("sta_WF_label01");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit33","138","49","105","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("3");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("Button16","245","49","25","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("4");
            obj.set_cssclass("btn_WF_down");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("Button00","245","21","25","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("5");
            obj.set_cssclass("btn_WF_down");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit00","138","21","105","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("6");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Static("Static01","7","77","125","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("7");
            obj.set_text("Reciever Bank");
            obj.set_cssclass("sta_WF_label01");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit01","138","77","105","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("8");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("Button01","245","77","25","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("9");
            obj.set_cssclass("btn_WF_down");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Static("Static02","7","105","125","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("10");
            obj.set_text("Ordering");
            obj.set_cssclass("sta_WF_label01");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit02","138","105","318","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("11");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit03","138","133","318","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("12");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit04","138","161","318","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("13");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit05","138","189","657","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("14");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Static("Static03","7","133","125","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("15");
            obj.set_text("Beneficiary");
            obj.set_cssclass("sta_WF_label01");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Static("Static04","7","161","125","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("16");
            obj.set_text("Beneficiary a/c");
            obj.set_cssclass("sta_WF_label01");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit06","271","21","233","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("17");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit07","271","49","233","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("18");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit08","271","77","233","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("19");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Static("Static06","522","21","125","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("20");
            obj.set_text("Details of Charge");
            obj.set_cssclass("sta_WF_label01");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Static("Static07","522","49","125","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("21");
            obj.set_text("Message Key");
            obj.set_cssclass("sta_WF_label01");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Static("Static08","522","77","125","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("22");
            obj.set_text("Their Trans. Date");
            obj.set_cssclass("sta_WF_label01");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Combo("Combo08","651","21","144","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("23");
            obj.set_text("SHA");
            obj.set_value("");
            obj.set_index("-1");
            ...
            obj = new Edit("Edit09","651","49","144","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("24");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit10","651","77","144","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("25");
            obj.set_value("0000/00/00");
            obj.set_text("0000/00/00");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Static("Static09","522","105","115","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("26");
            obj.set_text("Their Reference");
            obj.set_cssclass("sta_WF_label01");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit11","651","105","144","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("27");
            obj.set_text("0000/00/00");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Static("Static10","472","133","95","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("28");
            obj.set_text("Country Code");
            obj.set_cssclass("sta_WF_label01");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit12","577","133","46","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("29");
            obj.set_textAlign("center");
            obj.set_text("1");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("Button02","625","134","23","23",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("30");
            obj.set_cssclass("btn_WF_down");
            this.Tab00.Tabpage1.addChild(obj.name, obj);

            obj = new Edit("Edit13","651","133","144","25",null,null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("31");
            obj.set_text("0000/00/00");
            this.Tab00.Tabpage1.addChild(obj.name, obj);
            ...
            obj = new Static("Static37","1","10",null,"250","1",null,null,null,null,null,this.Tab00.Tabpage2.form);
            obj.set_taborder("0");
            obj.set_cssclass("sta_WF_box01");
            obj.set_text("");
            ...
            obj = new Static("Static14","31","113","765","132",null,null,null,null,null,null,this.Tab00.Tabpage2.form);
            obj.set_taborder("17");
            ...
            obj = new Button("Button01","623",null,"96","24",null,"58",null,null,null,null,this.Tab00.Tabpage2.form);
            obj.set_taborder("39");
            ...
            obj = new Button("Button02","723",null,"66","24",null,"58",null,null,null,null,this.Tab00.Tabpage2.form);
            obj.set_taborder("40");
            obj.set_text("복수거래");
            obj.set_cssclass("btn_WF_basic03");
            this.Tab00.Tabpage2.addChild(obj.name, obj);
        ...
        this.loadIncludeScript("w_fxircctrsf.xfdl");
