(function()
{
	return function()
	{
		nexacro._setCSSMaps(
		{
				...
				"class" :
				{
					...
					"btn_MF_tab_selected" :
					{
						"self" :
						{
							"enabled" :
							{
								...
								"border" : nexacro.BorderObject("0px none,1px solid #ed6e11,1px solid #ed6e11"),
								"textPadding" : nexacro.PaddingObject("5px"),
								"padding" : nexacro.PaddingObject("0px 5px 0px 5px")
							},
							"focused" :
					...
					"btn_WF_login" :
					{
						"self" :
						{
							"enabled" :
							{
								"color" : nexacro.ColorObject("#ffffff"),
								"border" : nexacro.BorderObject("0px none"),
								"font" : nexacro.FontObject("bold 22px \"Malgun Gothic\",\"Verdana\",\"Arial\"")
							},
							"focused" :
							{
								"color" : nexacro.ColorObject("#ffffff"),
					...
					"btn_WF_basic07" :
					{
						"self" :
						{
							...
							{
								"color" : nexacro.ColorObject("#555555"),
								"border" : nexacro.BorderObject("1px solid #d7af5a"),
								"font" : nexacro.FontObject("bold 12px \"Dotum\",\"Arial\"")
							},
							"focused" :
							{
							...
							"pushed" :
							{
								"border" : nexacro.BorderObject("1px solid #c59a3f")
							}
						}
					},
					"btn_WF_basic08" :
					{
						"self" :
						{
							...
							{
								"color" : nexacro.ColorObject("#555555"),
								"border" : nexacro.BorderObject("1px solid #fcaf8f"),
								"font" : nexacro.FontObject("bold 12px \"Dotum\",\"Arial\"")
							},
							"focused" :
							{
							...
							"pushed" :
							{
								"border" : nexacro.BorderObject("1px solid #fca07a")
							}
						}
					},
					"btn_WF_search" :
			...
			"Grid" :
			{
				"self" :
				{
					"enabled" :
					{
						"border" : nexacro.BorderObject("2px solid #ed6e11, 1px solid #b7b1b2, 1px solid #b7b1b2, 1px solid #b7b1b2")
					}
				},
				"class" :
				{
					"grd_LF_menu" :
					{
						"self" :
						{
							"enabled" :
							{
								"border" : nexacro.BorderObject("1px solid #ed6e11,1px solid #ed6e11,0px none,0px none")
							}
						}
					}
				}
				...
				"class" :
				{
					"PM_TF_popmenu" :
					{
						"self" :
						{
							"enabled" :
							{
								"border" : nexacro.BorderObject("2px solid #ed6e11,1px solid #b5b5b5,1px solid #b5b5b5")
							}
						}
					}
				}
				...
				"class" :
				{
					...
					"sta_WF_mainTitle" :
					{
						"self" :
						{
							"enabled" :
							{
								...
								"color" : nexacro.ColorObject("#00a6db")
							}
						}
					},
					"sta_WF_loginBox" :
					...
					"sta_WF_loginTitle" :
					{
						"self" :
						{
							"enabled" :
							{
								...
								"color" : nexacro.ColorObject("#ed6e11"),
					...
					"sta_WF_label03" :
					{
						"self" :
						{
							"enabled" :
							{
								"color" : nexacro.ColorObject("#e0670f"),
								"border" : nexacro.BorderObject("1px solid #d5d5d5"),
								"padding" : nexacro.PaddingObject("0px 10px 0px 10px")
							}
						}
					...
					"sta_WF_label04" :
					{
						"self" :
						{
							"enabled" :
							{
								"color" : nexacro.ColorObject("#c55401"),
								"border" : nexacro.BorderObject("1px solid #d5d5d5"),
								"padding" : nexacro.PaddingObject("0px 10px 0px 10px")
							}
						}
				...
				"parent" :
				{
					"Tab" :
					{
						"self" :
						{
							...
							{
								"color" : nexacro.ColorObject("#ffffff"),
								"border" : nexacro.BorderObject("1px solid #ed6e11")
							},
							"focused_selected" :
							{
								"color" : nexacro.ColorObject("#ffffff"),
		...
		imgcache[nexacro._getImageLocation("theme://images/img_TF_logo.png")] = { width:158, height:27 };
		...
		imgcache[nexacro._getImageLocation("theme://images/img_WF_mainLogo.png")] = { width:400, height:132 };
		imgcache[nexacro._getImageLocation("theme://images/img_WF_loginLogo.png")] = { width:250, height:76 };
