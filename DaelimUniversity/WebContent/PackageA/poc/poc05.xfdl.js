(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Button01","10","750","100","24",null,null,null,null,null,null,this);
            obj.set_taborder("58");
            obj.set_text("Swift Message");
            obj.set_cssclass("btn_WF_basic01");
            this.addChild(obj.name, obj);

            obj = new Button("Button09",null,"750","60","24","10",null,null,null,null,null,this);
            obj.set_taborder("59");
            obj.set_text("Exit");
            obj.set_cssclass("btn_WF_basic04");
            this.addChild(obj.name, obj);

            obj = new Button("Button14",null,"750","60","24","73",null,null,null,null,null,this);
            obj.set_taborder("60");
            obj.set_text("Clear");
            obj.set_cssclass("btn_WF_basic04");
            this.addChild(obj.name, obj);

            obj = new Button("Button15",null,"750","60","24","136",null,null,null,null,null,this);
            obj.set_taborder("61");
            obj.set_text("OK");
            obj.set_cssclass("btn_WF_basic05");
            this.addChild(obj.name, obj);

            obj = new Button("Button02","113","750","66","24",null,null,null,null,null,null,this);
            obj.set_taborder("62");
            ...
            obj = new Static("Static51","0","774",null,"5","0",null,null,null,null,null,this);
            obj.set_taborder("95");
            this.addChild(obj.name, obj);
