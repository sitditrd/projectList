if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("poc", "form", "./poc/", "session", null, "", "0", "0");
        nexacro._addService("lib", "js", "./lib/", "session", null, "", "0", "0");
        nexacro._addService("svc", "JSP", "http://14.63.224.112/", "none", null, "", "0", "0");
        nexacro._addService("Bim", "form", "./Bim/", "session", null, "", "0", "0");
        nexacro._addService("Cpm", "form", "./Cpm/", "session", null, "", "0", "0");
        nexacro._addService("Pim", "form", "./Pim/", "session", null, "", "0", "0");
        nexacro._addService("Common", "form", "./Common/", "session", null, "", "0", "0");
        nexacro._addService("Script", "js", "./Script/", "dynamic", null, "", "0", "0");
