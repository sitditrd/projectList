(function()
{
    return function()
    {
        ...
        {
            this.set_name("sample002");
            this.set_titletext("F15_ver02");
            this.getSetter("classname").set("sample002");
        ...
        // User Script
        this.registerScript("np_jQuery_animate_position.xfdl", function() {
        //전체 타일 갯수
        this.fv_PageCount = 6;
        ...
        this.sample002_onload = function(obj, e)
        {
        	//타일 생성 함수 호출
        	this.fn_createImage();
        ...
        this.fn_createImage = function()
        {
        	...
        	for(i=1;i<=this.fv_PageCount;i++)
        	{
        		...
        		objDiv.set_url("comm::np_jQuery_animate_positionDiv.xfdl");
        ...
        {
            this.addEventHandler("onload",this.sample002_onload,this);
        };

        this.loadIncludeScript("np_jQuery_animate_position.xfdl");
