(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static04","7","46","86","25",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text(" 조회조건1");
            ...
            obj = new Edit("Edit00","101","46","120","25",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Static("Static06","229","46","86","25",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("조회조건2");
            obj.set_cssclass("sta_WF_label01R");
            obj.set_textAlign("center");
            ...
            obj = new Calendar("Calendar00","323","46","120","25",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Static("Static08","451","51","12","25",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("~");
            obj.set_cssclass("sta_WF_label01L");
            this.addChild(obj.name, obj);

            obj = new Calendar("Calendar01","471","46","120","25",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Static("Static09","599","46","86","25",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("조회조건3");
            obj.set_cssclass("sta_WF_label01R");
            obj.set_textAlign("center");
            ...
            obj = new Combo("Combo00","693","46","120","25",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            ...
            obj = new Grid("grd_list","8","107",null,null,"8","8",null,null,null,null,this);
            obj.set_taborder("9");
            ...
            obj = new Button("Button00",null,"8","84","22","8",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("인쇄");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1010,691,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                ...
                p.Static03.set_cssclass("sta_cm_box01L");
                p.Static03.move("20","40",null,"47","20",null);

                p.Static04.set_taborder("1");
                p.Static04.set_text(" 조회조건1");
                p.Static04.set_cssclass("sta_WF_label01R");
                p.Static04.set_textAlign("center");
                p.Static04.move("7","46","86","25",null,null);

                p.Edit00.set_taborder("2");
                p.Edit00.set_readonly("true");
                p.Edit00.move("101","46","120","25",null,null);

                p.Static06.set_taborder("3");
                p.Static06.set_text("조회조건2");
                p.Static06.set_cssclass("sta_WF_label01R");
                p.Static06.set_textAlign("center");
                p.Static06.move("229","46","86","25",null,null);

                p.Calendar00.set_taborder("4");
                p.Calendar00.set_readonly("true");
                p.Calendar00.move("323","46","120","25",null,null);

                p.Static08.set_taborder("5");
                p.Static08.set_text("~");
                p.Static08.set_cssclass("sta_WF_label01L");
                p.Static08.move("451","51","12","25",null,null);

                p.Calendar01.set_taborder("6");
                p.Calendar01.set_readonly("true");
                p.Calendar01.move("471","46","120","25",null,null);

                p.Static09.set_taborder("7");
                p.Static09.set_text("조회조건3");
                p.Static09.set_cssclass("sta_WF_label01R");
                p.Static09.set_textAlign("center");
                p.Static09.move("599","46","86","25",null,null);

                p.Combo00.set_taborder("8");
                p.Combo00.set_innerdataset("Dataset00");
                p.Combo00.set_readonly("true");
                p.Combo00.set_text("Combo00");
                p.Combo00.move("693","46","120","25",null,null);

                p.grd_list.set_taborder("9");
                ...
                p.grd_list.move("8","107",null,null,"8","8");

                p.Button00.set_taborder("10");
                p.Button00.set_text("인쇄");
                p.Button00.set_cssclass("btn_WF_basic02");
                p.Button00.move(null,"8","84","22","8",null);

                p.Static00.set_taborder("11");
                p.Static00.set_text("데이터 처리");
                p.Static00.set_cssclass("sta_WF_title02");
                p.Static00.move("10","0","733","50",null,null);
            	}
            );
        ...
        this.work001_onload = function(obj,e)
        {
        ...
        this.work001_ontimer = function(obj,e)
        {
        	if (e.timerid == 1)
        	{
        ...
        ************************************************************************************************/
        ...
        {
            this.addEventHandler("onload",this.work001_onload,this);
            this.addEventHandler("ontimer",this.work001_ontimer,this);
