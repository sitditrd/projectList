if (nexacro.Environment)
{
    ...
    {
        this.set_themeid("theme::nexacro17MDI");
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("svcurl", "JSP", "http://localhost:8090/nexacro-demo/", "none", null, "", "0", "0");
        nexacro._addService("xeniurl", "JSP", "http://localhost:8090/nexacro17-xeni/", "none", null, "", "0", "0");
        ...
        nexacro._addService("BasicChart", "form", "./BasicChart/", "session", null, "", "0", "0");
        nexacro._addService("PieChart", "form", "./PieChart/", "session", null, "", "0", "0");
        nexacro._addService("BubbleChart", "form", "./BubbleChart/", "session", null, "", "0", "0");
        nexacro._addService("push_url", "file", "./push_url/", "session", null, "", "0", "0");
        ...
        var registerclass = [
        		...
        		{"id":"RadarChart", "classname":"nexacro.RadarChart", "type":""},
        		{"id":"PieChart", "classname":"nexacro.PieChart", "type":""},
        		{"id":"GaugeChart", "classname":"nexacro.GaugeChart", "type":""},
        		{"id":"BubbleChart", "classname":"nexacro.BubbleChart", "type":""},
        		{"id":"BasicChart", "classname":"nexacro.BasicChart", "type":""},
