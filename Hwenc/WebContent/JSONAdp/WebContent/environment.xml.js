if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("jsonsvc", "JSP", "JSONAdp://localhost/Hwenc/JSONAdp/nexacro/jsp/", "none", null, "", "0", "0");
        nexacro._addService("svc", "JSP", "http://localhost/Hwenc/JSONAdp/nexacro/jsp/", "none", null, "", "0", "0");
        nexacro._addService("file", "file", "./_extlib_/JSONAdp/", "none", null, "", "0", "0");
