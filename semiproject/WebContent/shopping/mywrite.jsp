...
<body>
	...
	<!-- 게시판 -->
	<br />
	<h1 class="my-4 pageHead">My Write</h1>
	<div class="container">
		<br />
				...
				<c:forEach items="${requestScope.aList}" var="dto">
					<tr>
						<c:url var="link" value="boardDetail.do">
							...
							<c:param name="post_date" value="${dto.re_level}" />
							<c:param name="post_views" value="${pdto.currentPage}" />
						</c:url>
				...
				<ul class="pagination justify-content-center">
					...
					<c:if test="${pdto.startPage > pdto.blockPage}">
						...
						<li class="page-item"><a class="page-link"
							aria-label="Previous"
							href="Mywrite.do?pageNum=${pdto.startPage - pdto.blockPage}">
					...
					<c:forEach begin="${pdto.startPage}" end="${pdto.endPage}" var="i">
						...
						<li class="page-item"><a class="page-link"
							href="Mywrite.do?pageNum=${i}">${i}</a></li>
						<!-- 현재 페이지 값=i -->
