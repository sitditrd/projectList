				...
				<table border="1" width="1200" class="main_table"
					...
					<tbody class="main">
						...
						<tr class="main_record">
							...
							<td class="product"><img class="card-img-top"
					...
					<tfoot>
						<tr>
							<td colspan="5">Total_Price : <fmt:formatNumber
									value="${dto.item_price}" type="number" />원
						</tr>
					</tfoot>
					<!-- /.container -->
				</table>
				...
				<table border="1" width="1200" class="main_table">
					...
					<tr>
						...
						<td><select name="receive_phone1"
							...
							maxlength="4" size="5" class="text-center"></input> - <input type="text"
							name="receive_phone3" id="receive_phone3" maxlength="4" size="5" class="text-center"></input></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>￦<fmt:formatNumber value="${dto.item_price}"
								type="number" />원 <input type="hidden" name="total_price"
							value="${dto.item_price}">
						</td>
					</tr>

					<tr>
						<td colspan="2" align="center"><input type="hidden"
							name="total_price" value="${dto.item_price}"> <!-- 단품주문이기에 item_price가 즉 total_price이다. -->
							<input type="hidden" name="item_name" value="${dto.item_name}">
							<input type="hidden" name="item_amount"
							value="${dto.item_amount}"> <input type="hidden"
							name="category_id" value="${dto.category_id}"> <input
							type="hidden" name="item_size" value="${dto.item_size}">
							<input type="hidden" name="item_price" value="${dto.item_price}">
							<input type="button" class="btn btn-primary" value="결제하기"
							id="btn-1"></input> <input type="reset" class="btn btn-danger"
							value="취소하기" id="btn-3"></input></td>
					</tr>
				</table>
			</form>
		</div>
