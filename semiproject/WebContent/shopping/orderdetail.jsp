	...
	$(document).ready(function() {
		...
		$('#cancelbtn').click(function() {
			if(confirm("결제를 취소하시겠습니까?")){
				alert('결제를 취소하였습니다.');
				location.href = "orderdelete.do?index=" + index;
			}	
			return false;
		});
...
<body>
	...
	<%
		String temp = (String) (request.getAttribute("total_price"));

		int total_price = Integer.parseInt(temp);
	...
	<div class="container">
		<h1 class="my-4 pageHead">Order Shipping Information</h1>
		<div class="row">
			...
			<form action="" method="post">
				<table border="1" width="1200" class="main_table">
					...
					<tr>
						...
						<td><input type="text" class="col-sm-4" name="order_date"
							readonly="readonly" value="<%=res_price%>"></input></td>
					</tr>
	...
	<div class="container">
		<h1 class="my-4 pageHead">Buyer Information</h1>
		<div class="row">
	...
	<div class="container">
		<h1 class="my-4 pageHead">Order Product Information</h1>
		<div class="row">
			<div class="orderListArea">
				<table border="1" width="1200" class="main_table"
					...
					<tfoot>
						<c:if test="${state == '결제완료'}">
							<tr>
								<td colspan="4"><%=res_price%>원</td>

								<td colspan="1"><input type="button"
									class="btn btn-danger btn-block login" id="cancelbtn"
									value="주문취소"></td>
							</tr>
						</c:if>

						<c:if test="${state == '취소완료'}">
							<tr>
								<td colspan="5"><%=res_price%>원</td>
							</tr>
						</c:if>
