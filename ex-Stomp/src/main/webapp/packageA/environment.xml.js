if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("Service0", "file", "./_extlib_/webSocketComponent/", "session", null, "", "0", "0");
        ...
        var registerclass = [
        		...
        		{"id":"webSocketComponent", "classname":"nexacro.webSocketComponent", "type":"JavaScript"}
        ];
