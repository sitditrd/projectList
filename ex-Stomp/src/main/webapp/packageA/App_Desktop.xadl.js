(function()
{
    return function()  
	{
        ...
        {
            var frame0 = new ChildFrame("ChildFrame00",null,null,null,null,null,null,"sample::webSocketComponent.xfdl",this);
            frame0.set_showtitlebar("false");
            frame0.set_showtitleicon("false");
            frame0.set_dragmovetype("none");
            this.addChild(frame0.name, frame0);
            frame0.set_formurl("sample::webSocketComponent.xfdl");
