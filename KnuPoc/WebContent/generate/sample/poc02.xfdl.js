(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1024,1200);
            }
            ...
            obj.set_codecolumn("code");
            obj.set_datacolumn("data");
            obj.set_displaynulltext("2018-03-20 화");
            obj.set_text("");
            obj.set_index("-1");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Button("Button06",null,"280","70","30","146",null,null,null,null,null,this.Div02.form);
            obj.set_taborder("1");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_btnR");
            this.Div02.addChild(obj.name, obj);

            obj = new Button("Button07",null,"280","70","30","73",null,null,null,null,null,this.Div02.form);
            obj.set_taborder("2");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_btnR");
            this.Div02.addChild(obj.name, obj);

            obj = new Button("Button08",null,"280","70","30","0",null,null,null,null,null,this.Div02.form);
            obj.set_taborder("3");
            obj.set_text("닫기");
            ...
            obj = new Combo("Combo04",null,"94","104","33","Static31:5",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("20");
            obj.set_innerdataset("Dataset01");
            obj.set_codecolumn("code");
            obj.set_datacolumn("data");
            ...
            obj = new Static("Static27",null,"94","60","33","Combo04:8",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("72");
            obj.set_text("영수증구분");
            this.Div01.addChild(obj.name, obj);
            ...
            obj = new Edit("Edit04","20.96%","174","Static16:29.57%","33",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("35");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1024,1200,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                ...
                p.Combo00.set_displaynulltext("2018-03-20 화");
                p.Combo00.set_text("");
                ...
                p.Combo01.set_datacolumn("data");
                p.Combo01.set_displaynulltext("2018-03-20 화");
                ...
                p.Button06.set_taborder("1");
                p.Button06.set_text("저장");
                p.Button06.set_cssclass("btn_WF_btnR");
                p.Button06.move(null,"280","70","30","146",null);

                p.Button07.set_taborder("2");
                p.Button07.set_text("삭제");
                p.Button07.set_cssclass("btn_WF_btnR");
                p.Button07.move(null,"280","70","30","73",null);

                p.Button08.set_taborder("3");
                p.Button08.set_text("닫기");
                p.Button08.set_cssclass("btn_WF_btnGr");
                p.Button08.move(null,"280","70","30","0",null);
                // this.Div02 }}
                ...
                p.Combo02.set_innerdataset("Dataset01");
                p.Combo02.set_codecolumn("code");
                p.Combo02.set_datacolumn("data");
                ...
                p.Combo03.set_codecolumn("code");
                p.Combo03.set_datacolumn("data");
                p.Combo03.set_text("Combo00");
                ...
                p.Combo04.set_codecolumn("code");
                p.Combo04.set_datacolumn("data");
                p.Combo04.set_text("Combo00");
                p.Combo04.move(null,"94","104","33","Static31:5",null);

                p.Static27.set_taborder("72");
                p.Static27.set_text("영수증구분");
                p.Static27.move(null,"94","60","33","Combo04:8",null);
                ...
                p.Combo06.set_innerdataset("Dataset01");
                p.Combo06.set_codecolumn("code");
                p.Combo06.set_datacolumn("data");
                p.Combo06.set_text("Combo00");
                ...
                p.Combo05.set_innerdataset("Dataset01");
                p.Combo05.set_codecolumn("code");
                p.Combo05.set_datacolumn("data");
                p.Combo05.set_text("Combo00");
                ...
                p.Combo07.set_innerdataset("Dataset01");
                p.Combo07.set_codecolumn("code");
                p.Combo07.set_datacolumn("data");
                p.Combo07.set_text("Combo00");
                ...
                p.Combo08.set_codecolumn("code");
                p.Combo08.set_datacolumn("data");
                p.Combo08.set_text("Combo00");
                ...
                p.Edit04.move("20.96%","174","Static16:29.57%","33",null,null);
                ...
                p.Combo09.set_codecolumn("code");
                p.Combo09.set_datacolumn("data");
                p.Combo09.set_text("Combo00");
            ...
            //-- Normal Layout : this
            obj = new Layout("Layout0","",768,1310,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                ...
                p.Button06.move("532","294","70","26",null,null);

                p.Button07.move("605","294","70","26",null,null);

                p.Button08.move(null,"294","70","26","0",null);
                // this.Div02 }}
                ...
                p.Combo04.move(null,"94","Static10:39.44%","33","Static31:5",null);
                ...
                p.Static27.move(null,"96","41","33","Combo04:0",null);
                ...
                p.Combo03.move("Static08:5","94","Static10:35.06%","33",null,null);
                ...
                // this.Div01 }}
                p = rootobj;
                p.Div02.move("10","970",null,"330","10",null);
            ...
            //-- Normal Layout : this
            obj = new Layout("Layout1","",480,810,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                ...
                p.Button06.move(null,"303","90","40","186",null);

                p.Button07.move(null,"303","90","40","93",null);

                p.Button08.move(null,"303","90","40","0",null);
                // this.Div02 }}
                ...
                p.Static39.move("10","650","130","81",null,null);

                p.Static40.move("Static39:-1","650",null,"81","10",null);

                p.TextArea01.move("Static39:5","656",null,"68","16",null);
                ...
                p.Static27.move(null,"174","Static10:22.65%","33","Combo04:8",null);
        ...
        this.Div01_FileUpload00_onitemchanged = function(obj,e)
        {
