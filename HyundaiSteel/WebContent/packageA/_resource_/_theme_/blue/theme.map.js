(function()
{
	return function()
	{
					...
					"Menu" :
					{
						"self" :
						{
							"enabled" :
							{
								"font" : nexacro.FontObject("12px Gulim"),
								"color" : nexacro.ColorObject("#555555"),
								"border" : nexacro.BorderObject("1px solid #00386b")
							}
						}
					}
				}
						...
						"parent" :
						{
							"Menu" :
							{
								"self" :
								{
									...
									{
										"color" : nexacro.ColorObject("#333333"),
										"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #0163bb, 0px none"),
		...
		imgcache[nexacro._getImageLocation("theme://images/img_WF_mainLogo.png")] = { width:533, height:167 };
