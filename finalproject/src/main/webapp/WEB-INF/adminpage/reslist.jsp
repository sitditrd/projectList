					...
					<div class="tab_and_sort">
						<ul class="topClBtn m_hide">
							<li><a href="javascript:reserve();"
								class="btn btn01 btn-color-w1 on" id="list_btn">예매내역<!-- 예매내역 --></a></li>
							<li><a href="javascript:cancel();"
								class="btn btn01 btn-color-w1" id="cancel_btn">취소내역<!-- 취소내역 --></a></li>
						</ul>
						...
						<tbody id="PNWRA00001_bookingList">
							...
							<c:forEach items="${aList}" var="dto">
								<tr>
									...
									<td><span style="color: blue;">${dto.reserve_state}</span></td>
									
									<td>
										<c:url var="content" value="adminresDetail.do">
					...
					<ul class="pagination justify-content-center">
						...
						<c:if test="${pv.startPage > 1}">
							<li class="page-item"><a class="page-link"
								aria-label="Previous"
								href="adminresList.do?currentPage=${pv.startPage - pv.blockPage}">
						...
						<c:forEach begin="${pv.startPage}" end="${pv.endPage}" var="i">
							...
							<li class="page-item"><span> <a class="page-link"
									href="adminresList.do?currentPage=${i}">${i}</a>
							</span></li>
