							...
							<section id="PNWRA00002" class="mr0101" style="display: block;">
								...
								<div class="tabWrapBox wrap social_hide">
									...
									<table class="bbs_list m_hide">
										...
										<thead>
											<tr>
												<th scope="col">취소사유</td>
												<td scope="col"><textarea name="content" rows="7" cols="80" style="background: none; border: none; vertical-align: middle; text-align: cen" readonly="readonly">${cancel_reason}</textarea></td>
											</tr>
										</thead>
									</table>
								...
								<div class="btn_ul m2 c_wrap">
									<a id="PNWRA00002_list_bn"
										...
										href="adminrescancelList.do?currentPage=${param.currentPage }">목록<!--목록--></a>
								</div>
							</section>
