...
<link href="vendor/bootstrap/css/haneda.css" rel="stylesheet">
...
<body
	...
	<div class="clearfix"></div>
		...
		<div class="container">
			<div class="row">
				...
				<div id="map"></div>
				<ul id="geoData" style="list-style: square; color: red; margin-top: 30px;" >
				
					<li><font color="white">Full Address: <span id="location"></span></font></li>
					<li><font color="white">Postal Code: <span id="postal_code"></span></font></li>
					<li><font color="white">Country: <span id="country"></span></font></li>
					<li><font color="white">Latitude: <span id="lat"></span></font></li>
					<li><font color="white">Longitude: <span id="lon"></span></font></li>
				</ul>
			</div>
		</div>
	...
	<script src="vendor/jquery/haneda.js"></script>
