...
<link href="vendor/bootstrap/css/bootstrap.adminpage.css" rel="stylesheet">
...
<body style="background-image: url('img/bg.jpg'); font-family: 'Lora'; background-attachment: fixed; background-position: center; background-size: cover;" id="body">
   ...
   <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav" style="background-color: #111111b5">
        ...
        <div class="slider-outer clearfix" id="slider-outer">
            <div class="slide clearfix">
                ...
                <div class="slide-details">
                    ...
                    <p>회원들의 개인정보를 조회 할 수있습니다.</p>
                    <button onclick="location.href='adminmemList.do'">Confirm</button>
                </div>
            </div>
            <div class="slide clearfix">
                ...
                <div class="slide-details">
                    <div class="header">
                        <h2>주문내역 확인<span class="top"></span><span class="bottom"></span><span class="left-border"></span></h2>
                    </div>
                    <p>예약된 주문내역을 확인합니다.</p>
                    <button onclick="location.href='adminresList.do'">Confirm</button>
                </div>
            </div>
            </div>
        </div>
	...
	<script src="vendor/jquery/jquery.adminpage.js"></script>
