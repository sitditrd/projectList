...
<link href="vendor/bootstrap/css/bootstrap.mypage.css" rel="stylesheet">
...
<body style="background-image: url('img/bg.jpg'); font-family: 'Lora'; background-attachment: fixed; background-position: center; background-size: cover;" id="body">
   ...
   <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav" style="background-color: #111111b5">
        ...
        <div class="slider-outer clearfix" id="slider-outer">
            <div class="slide clearfix">
                ...
                <div class="slide-details">
                    ...
                    <p>고객님의 개인정보를 수정,탈퇴 할 수있습니다.</p>
                    <button onclick="location.href='meminfo.do'">Confirm</button>
                </div>
            </div>
            <div class="slide clearfix">
                ...
                <div class="slide-details">
                    <div class="header">
                        <h2>결제내역 확인<span class="top"></span><span class="bottom"></span><span class="left-border"></span></h2>
                    </div>
                    <p>고객님의 결제내역을 확인할 수 있습니다.</p>
                    <button onclick="location.href='resList.do'">Confirm</button>
                </div>
            </div>
            </div>
        </div>
	...
	<script src="vendor/jquery/jquery.test3.js"></script>
