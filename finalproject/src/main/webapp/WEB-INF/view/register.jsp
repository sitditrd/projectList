	...
	function overlapCheck() {
		...
		//ajax통신(사용자 ID 중복체크)
			...
			$.ajax({
				type:'POST',
				dataType:'json',
				url:'idcheck.do?user_id='+$('#fid').val(),
				success:viewMessage
			});
		}
	}
...
<body style="background-image: url('img/bg.jpg'); font-family: 'Lora'; background-attachment: fixed; background-position: center; background-size: cover;" id="body">
    ...
    <div class="card card-register mx-auto mt-5">
      <div class="card-header" style="font-size: 40px; font-style: italic;" align="center">Register an Account</div>
      <div class="card-body">
      
        <form name="frm" action="signUp.do" method="post" onsubmit="return checkValue()">
          <div class="form-group">
            <label for="exampleInputEmail1" style="font-style: italic;">ID</label>
            <input class="form-control" name="id" id="fid" type="text" aria-describedby="emailHelp" placeholder="Enter ID">
          </div>
          
          <a class="btn btn-success btn-block" id="btn-1" onclick="overlapCheck()">IDCheck</a>
          <br/>
          <!-- 중복체킹버튼 눌렀는지 아닌지 판별 : chk / 아이디를 다시 중복체킹하기 위해서 : chk2 -->
          <input type="hidden" id="chk" value="N"/> 
          <input type="hidden" id="chk2" value="N"/>
          
          <div class="form-group">
            <label for="exampleInputEmail1" style="font-style: italic;">Password</label>
            <input class="form-control" name="password" id="fpass" type="password" aria-describedby="emailHelp" placeholder="Enter Password">
          </div>
         
          <div class="form-group">
            <label for="exampleInputEmail1" style="font-style: italic;">Name</label>
            <input class="form-control" name="name" id="fname" type="text" aria-describedby="emailHelp" placeholder="Enter name">
          </div>
          
          <div class="form-group">
            <label for="exampleInputEmail1" style="font-style: italic;">Birth</label>
            <input class="form-control" name="birth" id="fbirth" type="text" aria-describedby="emailHelp" placeholder="ex (&nbsp;1993년  04월 09일&nbsp;)">
          </div>
            
         <div class="form-group">
            <label for="exampleInputEmail1" style="font-style: italic;">Tel</label>
            <input class="form-control" name="tel" id="ftel" type="text" aria-describedby="emailHelp" placeholder="ex (&nbsp;010-4088-4691&nbsp;)">
          </div>
          
          <div class="form-group">
            <label for="exampleInputEmail1" style="font-style: italic;">Email</label>
            <input class="form-control" name="email" id="femail" type="email" aria-describedby="emailHelp" placeholder="Enter Email">
          </div>
          
          <div class="form-group">
            <label for="exampleInputEmail1" style="font-style: italic;">Address</label>
            <input class="form-control" name="address" id="sample4_postcode" type="text" aria-describedby="emailHelp" placeholder="Enter Address">
          ...
          <button class="btn btn-primary btn-block" type="submit" id="btn-2">Register</button>
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="login.do" style="font-style: italic;">Login Page</a>
          <a class="d-block small" href="find.do" style="font-style: italic;">Forgot Password?</a>
        </div>
      </div>
    </div>
  </div>
