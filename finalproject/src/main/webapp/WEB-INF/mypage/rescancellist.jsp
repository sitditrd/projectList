...
$(document).ready(function() {
	$('#cancel_btn').click(function() {
		$('#frm').attr('action', 'rescancelList.do').submit();
	});
	
	$('#list_btn').click(function() {
		$('#frm').attr('action', 'resList.do').submit();
	});
});
</script>
<!-- Bootstrap core CSS -->
		...
		<div class="container">
			<div class="content">
				<section id="PNWRA00001" style="display: block;">
					<div style="font-size: 45px; font-weight: bold; font-family: sans-serif;">나의예매</div>
					<br/>
					<br/>
						...
						<tbody id="PNWRA00001_bookingList">
							...
							<c:forEach items="${aList}" var="dto">
								<tr>
									...
									<td>
										<c:url var="content" value="rescancelDetail.do">
					...
					<ul class="pagination justify-content-center">
						...
						<c:if test="${pv.startPage > 1}">
							<li class="page-item"><a class="page-link"
								aria-label="Previous"
								href="rescancelList.do?currentPage=${pv.startPage - pv.blockPage}">
						...
						<c:forEach begin="${pv.startPage}" end="${pv.endPage}" var="i">
							...
							<li class="page-item"><span> <a class="page-link"
									href="rescancelList.do?currentPage=${i}">${i}</a>
							</span></li>
