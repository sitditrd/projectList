							...
							<section id="PNWRA00002" class="mr0101" style="display: block;">
								<div class="txtbox_i txtbox_i2 mt_25 ">
									...
									<span class="r_Txt social_hide"> <a
										...
										<a id="PNWRA00002_reservation_cancal_bu" href="javascript:;"
										class="btn btn03 btn-color02" style="">예매취소<!--예매취소--></a>
									</span>
								</div>
								...
								<div class="btn_ul m2 c_wrap">
									<a id="PNWRA00002_list_bn"
										...
										href="resList.do?currentPage=${param.currentPage }">목록<!--목록--></a>
								</div>
							</section>
