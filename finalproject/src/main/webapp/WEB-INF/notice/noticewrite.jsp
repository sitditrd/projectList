...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$('#btnSave').bind('click',function(){
			...
			$('#frm').attr('action','noticewrite.do').submit();
		});
...
<body style="background-image: url('img/bg.jpg'); font-family: 'Lora'; background-attachment: fixed; background-position: center; background-size: cover;" id="body">
	...
	<div class="card-header" align="center">
		...
		<div class="container">
		<br />
		<form id="frm" name="frm" method="post" action="noticewrite.do" enctype="multipart/form-data">
			<table class="table">
				<colgroup>
					<col width="95">
					<col width="190">
					...
					<tr>
						...
						<td colspan="3">
							<div class="form-group col-md-4 div-align-middle">
								<input class="form-control" type="text" id="notice_subject" name="notice_subject" size="90">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td colspan="3">
							<div class="form-group col-md-4 div-align-middle">
								<textarea id="notice_content" name="notice_content" class="form-control" rows="10" cols="100"></textarea>
							</div>
						</td>
					</tr>
			...
			<div class="text-right" style="margin-right: 100px;">
				<input class="btn page-link float-left" type="button" id="btnSave" value="저장" />
				<a class="btn page-link float-left" href="#" onclick="history.go(-1)" style="margin-left: 10px">취소</a>
			</div>
