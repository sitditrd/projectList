var data_value = 1;
var korprice = 703500;	//!!!!!!!!!!!!!!!!!!!!!(수정)!!!!!! db의 가격 받아오기
var chkgender = '';	//성별 빈칸 확인
var count = 2; //!!!!!!!!!!!!!!!!!!(수정) 탑승객 수
...
$(document).ready(function() {
	...
	$('.book-currency-list a').click(function() {
		...
		var totalprice = (korprice / data_value).toFixed(2);
		
		// alert("id:"+$(this).attr('id')+"name:"+$(this).attr('name')+"그price"+
		// korprice +"환율" + data_value);
		
		$('.book-currency-list > a').attr('class', '');
		$(this).attr('class', 'active');
		$('.amount').html($(this).attr('data-currency'));
		$('#submitTotalPrice').html($('.amount').html()+ ' '+ numberWithCommas(totalprice));
	});
