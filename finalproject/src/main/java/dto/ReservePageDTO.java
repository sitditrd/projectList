...
public class ReservePageDTO {
	...
	public ReservePageDTO(int currentPage, int totalCount) {
	...
	public ReservePageDTO(int currentPage, int totalCount, String reserve_state) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
		this.reserve_state = reserve_state;
	...
	public ReservePageDTO(String member_id, int currentPage, int totalCount, String reserve_state) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
		this.member_id = member_id;
		this.reserve_state = reserve_state;
